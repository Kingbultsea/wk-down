<template>
  <div class="ali">
    ...
    <div class="template">
      ...
      <img src="../assets/绑定银联卡_slices/cosleep_guidance_img_pay-1@3x.png">
    </div>
    <div class="template">
      <p>3. 勾选【银联/信用卡/借记卡】填写你的相关信息， 然后点击【完成】</p>
      <img src="../assets/绑定银联卡_slices/cosleep_guidance_img_creditcard@3x.png">
    </div>
    <div class="template">
      <p>4. 绑定完成后，回到【小睡眠】App-【充值中心】， 点击你想要充值的金额充值即可</p>
      <img src="../assets/绑定银联卡_slices/cosleep_guidance_img_pay-2@3x.png">
    </div>
    <div class="template">
      <p >注意事项: </p>
      ...
      <p class="remove-p">3.若绑定不成功，请确认你的银行卡信息填写无误，确认后再次进行绑定； </p>
