      ...
      desc: {
        ...
        free: [
          [
            ...
            { authenticate: ['钱没赚够，觉也没睡好。', '熬夜？没有，不是，别瞎说。', '你的黑眼圈比黑洞都深邃。', '做不完的工作，熬不完的夜。', '熬夜是小事，为工作不值一提！'], advance: ['该员工恪尽职守，已严重透支，建议带薪休假14天。', '此人因熬夜过度肥胖，特批一个月带薪减肥假。'] },
            { authenticate: ['革命尚未成功，同志仍需熬夜。', '创作灵感一上来，难以停下来。', '沉迷于工作无法自拔。', '睡觉只能做梦，工作将会圆梦。', '熬夜考证复习，考后卧床不起。'], advance: ['致老板，此人过于拼命，建议涨2倍工资。', '该员工因熬夜，比同龄人更成熟，更适合升职做领导。'] }
          ],
          [
