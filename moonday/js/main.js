...
'双黄莲蓉','流心奶黄','红豆月饼','五仁月饼','云腿月饼',
            ...
            else if(similly>=0 && similly<=6){ changeOneSrc.src = 'images/number_9.svg';   }
            else if(similly>6 && similly<=10){ changeOneSrc.src = 'images/number_9.svg'; degreed.innerText = "等级：Lv9民间画圣"; information.innerText = ["心中有规矩便能徒手画月饼。","磨具做出的月饼，还没你画的圆！"][Math.round(Math.random())] }
            else if(similly>10 && similly<=16){ changeOneSrc.src = 'images/number_8.svg'; degreed.innerText = "等级：Lv8绘画宗师"; information.innerText = ["挥一挥手指，画个大饼来充饥。","举头望明月，低头大饼香。"][Math.round(Math.random())]}
            else if(similly>16 && similly<=19){ changeOneSrc.src = 'images/number_7.svg'; degreed.innerText = "等级：Lv7天才画家"; information.innerText = ["十五的月饼，十六圆。","画不圆的月饼，在你心里骚动。"][Math.round(Math.random())]}
            else if(similly>19 && similly<=26){ changeOneSrc.src = 'images/number_6.svg'; degreed.innerText = "等级：Lv6灵魂画手"; information.innerText = ["画月饼？不存在的，这明明是个哈密瓜。","别人画月饼，你画个盘子。"][Math.round(Math.random())]}
            else if(similly>26 && similly<=35){ changeOneSrc.src = 'images/number_5.svg'; degreed.innerText = "等级：Lv5绘画达人"; information.innerText = ["你画的月饼是艺术，别人很难懂！","画月饼？不存在的，这明明是个哈密瓜。"][Math.round(Math.random())]}
            else if(similly>35 && similly<=40){ changeOneSrc.src = 'images/number_4.svg'; degreed.innerText = "等级：Lv4画室学徒"; information.innerText = ["你画的月饼是艺术，别人很难懂","你画的月饼，是被玉兔偷吃了吗？"][Math.round(Math.random())]}
            else if(similly>40 && similly<=50){ changeOneSrc.src = 'images/number_3.svg'; degreed.innerText = "等级：Lv3绘画能手"; information.innerText = '心中有月饼，画什么都能吃！'}
            else if(similly>50 && similly<=60){ changeOneSrc.src = 'images/number_2.svg'; degreed.innerText = "等级：Lv2新手临摹"; information.innerText = '月饼，在哪？完全没看见！'}
            else if(similly>60 && similly<=80){ changeOneSrc.src = 'images/number_2.svg'; degreed.innerText = "等级：Lv2新手临摹"; information.innerText = '月饼，在哪？完全没看见！'}
            else if(similly>80){ changeOneSrc.src = 'images/number_1.svg'; degreed.innerText = "等级：Lv1手残菜鸟"; information.innerText = ["月饼被谁吃了一口啦？","月饼被吃货藏起来了，你猜是谁"][Math.round(Math.random())] }
