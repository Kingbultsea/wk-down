...
<span lang="EN-US"><o:p></o:p></span></span></p><p>`
                    ...
                    break;
                case 8: {  // 8
                    this.rawHtmlData = `<h3><b>心潮呼吸瘦身法</b></h3><p>大量研究表明，腹式呼吸不仅可以帮助消耗腹部脂肪，改善心肺功能，还可以在一定程度上帮助放松身心。睡前通过腹式呼吸这种简单的运动，不仅可以促进疲劳释放，还可以帮助提高睡眠质量。</p><p>本练习结合了腹式呼吸练习与渐进式催眠放松，不仅可以帮助利用睡前这个时间瘦身减腹，还可以帮助提高入睡效率与提升睡眠质量，达到更健康的瘦身效果。</p><p><span style="font-weight: bold;">该练习适合除了孕妇以外的所有人群，每晚睡前练习。</span>高血压和哮喘患者需有家人陪同练习。</p>`
                }
                    break;
